...
<?php
dfb($site_name, "site_name" );
?>

<body class="<?php print airplaytheme2_column_count_class($left, $content, $right, $right_2) . $body_class; ?>">
  <div id="container">

<!--    
AP_REMOVED: 
<div id="accessiblity" class="width-48-1024 last nofloat">
      <a href="#content"><?php print t('Skip to main content'); ?></a>
    </div>-->

    <?php if ($leaderboard): ?>
      <div id="leaderboard" class="width-48-1024 last nofloat">
       <?php print $leaderboard; ?>
      </div> <!-- /leaderboard -->
    <?php endif; ?>

    <?php if ($logo || $site_name || $site_slogan || $search_box): ?>
      <div id="header" class="width-48-1024 last nofloat clearfix">
          <a href="/">
            <div class="logo"></div>
          </a>
        <!--  <div class="flags">
			<a href="http://www.airplaymusic.dk/"><img width="16" height="12" class="language-icon" border="0" src="/sites/all/modules/languageicons/flags/da.png"></a>&nbsp;
			<a href="http://www.airplaymusic.co.uk/"><img width="16" height="12" class="language-icon" border="0" src="/sites/all/modules/languageicons/flags/en.png"></a>
		  </div> -->
   ...
   <!-- <div id="main-navigation" class="width-48-1024 last nofloat clearfix">
    ...
    <?php if ($secondary_links): ?> 
      <div id="secondary-menu" class="width-48-1024 last nofloat">
    ...
    <?php if ($header): ?>
      <div id="header" class="width-48-1024 last nofloat">
        <?php print $header; ?>
      </div> <!-- /header -->
    <?php endif; ?>

    <?php if ($content_top_full_width || $content_top_left || $content_top_content): ?>
      <div id="content-top" class="width-48-1024 last nofloat">	
        <?php if ($content_top_full_width): ?>
          <div id="content-top-full-width" class="width-48-1024 last nofloat">
    ...
    <div id="col_wrapper" class="width-1024">
      ...
      <div id="content" class="<?php print airplaytheme2_col_width($left, $content, $right, $right_2); ?>">
      ...
      <?php if (($right_top_box || $right_bottom_box) && ($right_2 && $right)): ?>
        ...
        <?php endif; ?>
          ...
          <?php if ($right_2): ?>
            <div id="right_2" class="width-10-280">
              <?php print $right_2; ?>
            </div> <!-- /right 2 -->
          <?php endif; ?>

          <?php if ($right): ?>
            <div id="right" class="width-10-300 last">
              <?php print $right; ?>
            </div> <!-- /right -->
          <?php endif; ?>
    ...
    <?php if ($content_bottom_full_width || $content_bottom_left || $content_bottom_right): ?>
      <div id="content-bottom" class="width-48-1024 last nofloat">
        ...
        <?php if ($content_bottom_full_width): ?>
          <div id="content-bottom-full-width" class="width-48-1024 last nofloat">
    ...
    <?php if ($footer): ?>
      <div id="footer" class="width-48-1024 last nofloat">
        <?php print $footer; ?>
      </div>  <!-- /footer -->
    <?php endif; ?>

    <?php if ($footer_message): ?>
      <div id="footer-message" class="width-48-1024 last nofloat small">
