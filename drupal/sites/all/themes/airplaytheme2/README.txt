  ...
  http://drupal.org/project/airplaytheme2
  
  Please contact jeff [att] adaptivethemes [a.dot] com for customizations.

  Installation and basic configuration:

  1. Download AirplayTheme2 theme from http://drupal.org/project/airplaytheme2


  2. Unpack the downloaded file, take the entire airplaytheme2 folder (which includes
  ...
  3. Log in as an administrator on your Drupal site and go to:
     ...
     and make airplaytheme2 the default theme.


  4. Theme Settings.

     Go to:
     Administer > Site building > Themes > Configure > AirplayTheme2 (admin/build/themes/settings/airplaytheme2) 
     and configure settings for the airplaytheme2 theme. 
	 
     All features are supported but you can only display a logo OR the site name. 
     If the logo is checked, airplaytheme2 will display the logo - you must uncheck 
  ...
  5. Blocks.
     ...
     Go to: 
     Administer > Site building > Blocks (admin/build/block/list/airplaytheme2)
     and configure your block settings.
	 
     AirplayTheme2 has 4 columns and multiple additional regions.
  ...
  6. Default Avatar.
     ...
     for users and paste in the path "sites/all/themes/airplaytheme2/images/avatar.png".
     Modify the path if you have installed airplaytheme2 in a different directory. 
	 
     AirplayTheme2 is designed to support user pictures/avatars of the default size 
