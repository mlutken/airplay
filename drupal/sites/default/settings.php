 ...
 */
$db_url['default'] = 'mysqli://airplay_user:Deeyl1819@localhost/airplay_drupal';
//$db_url['airplay_music'] = 'mysqli://airplay_user:Deeyl1819@localhost/airplay_music_small';
$db_url['airplay_music'] = 'mysqli://airplay_user:Deeyl1819@localhost/airplay_music';
$db_prefix = '';
...
//if ( !onLocalHost() ) {
//	$base_url = 'http://airplaymusic.dk';  // NO trailing slash!
//}

//$base_url = 'http://airplay.localhost';	// NO trailing slash!
...
// --------------------------------------------------
// --- Fix language prefix/settings for localhost ---
// --------------------------------------------------
if ( onLocalHost() ) {
	$language = array(
		'language' => 'en',
		...
		'plurals' => 0,
		'formula' => '',
		'domain' => 'http://airplaymusic.co.uk.localhost',
		'prefix' => '',
		'weight' => 0,
		'javascript' => ''
	);
	
	if (false !== strpos($_SERVER['HTTP_HOST'], '.dk')) {
		$language['language'] = 'da';
		$language['name'] = 'Danish';
		$language['native'] = 'Dansk';
		$language['domain'] = 'http://airplaymusic.dk.localhost';
	} 
...
//$base_url = 'http://airplay.localhost';	// NO trailing slash!
    ...
    $language = array(
        ...
        'plurals' => 0,
        'formula' => '',
        'domain' => 'http://www.airplaymusic.co.uk',
        'prefix' => '',
        'weight' => 0,
        'javascript' => ''
    );
    ...
    if (false !== strpos($_SERVER['HTTP_HOST'], '.dk')) {
        ...
        $language['name'] = 'Danish';
        $language['native'] = 'Dansk';
        $language['domain'] = 'http://www.airplaymusic.dk';
    } 
...
$conf['session_inc'] = 
'./sites/all/modules/no_anon/session-no-anon.inc';
