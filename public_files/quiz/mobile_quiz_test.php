...
<div data-role="page" id="autoCreateQuizPageID" data-add-back-btn="false" class="defaultBackground" >
    <div data-theme="a" data-role="header" data-position="fixed" >
        ...
        <a href="/quiztest/mobile_quiz_test.php" data-icon="home" data-theme="a" data-iconpos="right" >Home</a>
    </div>
    <div data-role="content">
...
{
    var sShareUrl = quizGetAutoLoadUrl ("http://public.airplaymusic.dk/quiztest/mobile_quiz_test.php");
...
//    var sShareUrl = "http://www.airplaymusic.dk";
    var sShareUrl = "http://public.airplaymusic.dk/quiztest/mobile_quiz_test.php";
...
$( "#quizWelcomePageID" ).on( "pageshow", function( event, ui ) {
	if ( quizGetAutoLoadName () != "" ) {
		window.location.href = "/quiztest/mobile_quiz_test.php#quizWelcomePageID"; // Remove autoload params from URL
		return;
	}
});
...
$( "#autoCreateQuizPageID" ).on( "pageshow", function( event, ui ) {
	if ( quizGetAutoLoadName () != "" ) {
		window.location.href = "/quiztest/mobile_quiz_test.php#autoCreateQuizPageID"; // Remove autoload params from URL
		return;
	}
});
...
$( "#shareMainQuizPageID" ).on( "pageshow", function( event, ui ) {
    if ( quizGetAutoLoadName () != "" ) {
        window.location.href = "/quiztest/mobile_quiz_test.php#shareMainQuizPageID"; // Remove autoload params from URL
        return;
    }
