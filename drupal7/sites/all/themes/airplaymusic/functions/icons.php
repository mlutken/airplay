...
*/
function airplaymusic_feed_icon($variables) {
...
function airplaymusic_calendar_ical_icon($vars) {
  $url = $vars['url'];
...
/*file icons*/
function airplaymusic_file_link($variables) {
  $file = $variables['file'];
...
/*
function airplaymusic_file_icon($variables) {
  $file = $variables['file'];
