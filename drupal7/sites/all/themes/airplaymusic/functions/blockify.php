...
function airplaymusic_blockify_logo($variables) {
 ...
 * @ingroup themeable
 */
function airplaymusic_blockify_site_name($variables) {
 ...
 * @ingroup themeable
 */
function airplaymusic_blockify_site_slogan($variables) {
 ...
 */
// remove the  id & title 
function airplaymusic_blockify_page_title($variables) {
 ...
 * @ingroup themeable
 */
function airplaymusic_blockify_breadcrumb($variables) {
...
function airplaymusic_blockify_local_actions($variables) {
 ...
 * @ingroup themeable
 */
function airplaymusic_blockify_feed_icons($variables) {
 ...
 */
 ...
 //removed the clearfix
function airplaymusic_blockify_menu_local_tasks($variables) {
