...
class DataRedisSimpleNameBase
{
    ...
    public function createNew ( $record_store_name )
    {
        ...
        $ln = toLookUpName($record_store_name); 
        $this->m_r->sadd($ln . ':id', $id  );               // Add name to global lookup. Since we could have song names etc. with same name as a record_store we add to a set here
        $this->m_r->set( $ln . ':record_store_id', $id  );  // Add name to record_store lookup
        return $id;
    }
    ...
    public function updateBaseData ($aData)
    {
        ...
        redisHashSetData ( $this->m_r, $record_store_id, $aData, RecordStoreDataRedis::$m_aTblFields );
     }
    ...
    public function updateBaseDataCheckOld ($aData)
    {
        ...
        redisHashSetData ( $this->m_r, $record_store_id, $aData, RecordStoreDataRedis::$m_aTblFields,  $aDataOld, 'record_store_reliability' );
     }
    ...
    // ---------------------
    protected       $m_r = null;
    static          $m_aTblFields = array( 'record_store_name', 'record_store_url', 'country_id', 'use_affiliate', 'affiliate_link', 'affiliate_encode_times', 'record_store_reliability' );
