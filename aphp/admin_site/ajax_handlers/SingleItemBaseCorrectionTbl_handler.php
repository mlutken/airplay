...
$mainName       = 'SingleItemBaseCorrectionTbl';
$tblBaseName    = 'item_base_correction';
$fac = new MusicDatabaseFactory();
$db = $fac->createDbInterface("ItemBaseCorrectionData");
$ui = new SingleItemBaseCorrectionTblUI( $mainName, $tblBaseName );
