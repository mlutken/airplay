...
*/
class UnknownMediaTypesDataMySql
{
    // ------------------------
    // --- Constructor init --- 
    // ------------------------
    ...
    public function setData ($media_type_name, $record_store_id, $buy_at_url )
    {
        $stmt = $this->m_dbPDO->prepare("
        REPLACE INTO unknown_media_type  
        SET media_type_name = ?, record_store_id = ?, buy_at_url = ?" );
        $stmt->execute( array($media_type_name, $record_store_id, $buy_at_url) );
