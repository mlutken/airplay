...
class UnknownGenresDataMySql
{
    ...
    public function setData ($genre_name, $record_store_id, $buy_at_url )
    {
        $stmt = $this->m_dbPDO->prepare("
        REPLACE INTO unknown_genre  
        SET genre_name = ?, record_store_id = ?, buy_at_url = ?" );
        $stmt->execute( array($genre_name, $record_store_id, $buy_at_url) );
